...
- Possibilité de **partitionner** ou **trier** les données (par région, année, etc.)
- Améliore la vitesse de lecture de sous-échantillons
...
| 🔍 Fonction                  | 🦆 `DuckDB`                         |
|-----------------------------|-------------------------------------|
| Installation                | Pas de serveur, juste une librairie (`duckdb`)   |
